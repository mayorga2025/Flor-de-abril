...
(function(){
  const costumes = [
    ...
    { id:8, name:"baile de los mantudos", description:"danza tradicional representativa de chinandega , considerada una celebración regliosa celebrada en el mes de mayo.", image:"assets/huipiles/huipil_002.png", price:"C$ 400", sizes:["S","M","L"], category:"Mujer", region:"Central", colors:[{name:"Multicolor",hex:"#DC2626"}]},
    { id:9, name:"Baile de El Viejo y la Vieja ", description:"Este danzas es muy popular en todo el pais, originaria de managua es una danza muy caracteristica por la alegria que tranmite entre la población.", image:"assets/huipiles/huipil_003.png", price:"C$ 400", sizes:["S","M","L"], category:"Mujer", region:"Central", colors:[{name:"Multicolor",hex:"#DC2626"}]},
    { id:10, name:"La novia de Tola", description:"Esta es una obra teatral de la ciudad de rivas muy popular en todo el pais se basa en la historia de una novia a la cual dejaron planta en el altar.", image:"assets/huipiles/huipil_004.png", price:"C$ 400", sizes:["S","M","L"], category:"Mujer", region:"Central", colors:[{name:"Multicolor",hex:"#DC2626"}]},
    { id:13, name:"El güegüense o macho ratón", description:"Danza originaria del departamento de carazo la cual se basa en una burla la cual le realizaban a los españoles que vinieron a colonizar el pais.", image:"assets/huipiles/huipil_007.png", price:"C$ 400", sizes:["S","M","L"], category:"Mujer", region:"Central", colors:[{name:"Multicolor",hex:"#DC2626"}]},
    { id:16, name:"Inditas de monimbo", description:"Es una danza de origen indigena en la cual con su coreografi imitan las labores del dia adia.", image:"assets/huipiles/huipil_010.png", price:"C$ 400", sizes:["S","M","L"], category:"Mujer", region:"Central", colors:[{name:"Multicolor",hex:"#DC2626"}]},
    { id:17, name:"El baile de negras", description:"Es una danza interpretada por parejas en la cual ambos son varones y es muy comun verlas para las festividades de san jeronimo .", image:"assets/huipiles/huipil_011.png", price:"C$ 400", sizes:["S","M","L"], category:"Mujer", region:"Central", colors:[{name:"Multicolor",hex:"#DC2626"}]},
    { id:20, name:"polka nicaragüense", description:"Es una danza la cual se realiza de manera rapida, giros, zapteados donde predmina la alegria entre los danzantes.", image:"assets/huipiles/huipil_014.png", price:"C$ 400", sizes:["S","M","L"], category:"Mujer", region:"Central", colors:[{name:"Multicolor",hex:"#DC2626"}]},
